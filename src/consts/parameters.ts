...
// Wallet connect configuration options
export const paperClientIdConst = "f4d2fc79-523f-4b45-ba1c-32ffa8a53872"; // Paper wallet client ID
export const magicLinkApiKeyConst = "pk_live_5BD2E64C36DC78AA"; // Magic link API key
